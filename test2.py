...
class Muscle(Screen):
    ...
    def Update(self, *args):
        x,y = Window.size
        self.btn_biceps.pos = (350/800*x, 415/600*y)
        self.tailor_muscle.pos = (310/800*x, 265/600*y)
        self.rectus_femoris_muscle.pos = (320/800*x, 240/600*y)
        self.triceps.pos = (230/800*x, 400/600*y)
        self.Quadriceps_thigh_muscle.pos = (305/800*x, 210/600*y)
