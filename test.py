...
class Muscle(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn_biceps = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #Біцепс
                          size_hint = (None, None), size = (20, 20), pos = (350/800*x, 415/600*y))
        ...
        self.tailor_muscle = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",   #кравецький м'яз
                          size_hint = (None, None), size = (20, 20), pos = (310/800*x, 265/600*y))
        ...
        self.rectus_femoris_muscle = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png", #Прямий м'яз стегна
                          size_hint = (None, None), size = (20, 20), pos = (320/800*x, 240/600*y))
        ...
        self.triceps = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #тріцепс
                          size_hint = (None, None), size = (20, 20), pos = (230/800*x, 400/600*y))
        ...
        self.Quadriceps_thigh_muscle = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #квадріцепс
                          size_hint = (None, None), size = (20, 20), pos = (305/800*x, 210/600*y))
        ...
        self.Gluteal_muscles = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #попа
                          size_hint = (None, None), size = (20, 20), pos = (320/800*x, 270/600*y))
        ...
        self.lumbar = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       ##Великий Поперековий м'яз
                          size_hint = (None, None), size = (20, 20), pos = (248/800*x, 315/600*y))
        ...
        self.delta = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #delta
                          size_hint = (None, None), size = (20, 20), pos = (227/800*x, 455/600*y))
        ...
        self.forearm = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #Предплечье
                          size_hint = (None, None), size = (20, 20), pos = (360/800*x, 350/600*y))
        ...
        self.pectoral = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #Грудь
                          size_hint = (None, None), size = (20, 20), pos = (320/800*x, 440/600*y))
        ...
        self.toothed = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #зубчастые
                          size_hint = (None, None), size = (20, 20), pos = (255/800*x, 390/600*y))
        ...
        self.abdominis = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #Живот(прес)
                          size_hint = (None, None), size = (20, 20), pos = (295/800*x, 370/600*y))
        ...
        self.back_muscle = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #Живот(прес)
                          size_hint = (None, None), size = (20, 20), pos = (265/800*x, 370/600*y))
        ...
        self.trapezius = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #Живот(прес)
                          size_hint = (None, None), size = (20, 20), pos = (280/800*x, 400/600*y))
        ...
        self.platysmal = Button(background_normal = "images/Circle.png", background_down = "images/Circle.png",       #Живот(прес)
                          size_hint = (None, None), size = (25, 25), pos = (290/800*x, 485/600*y))
        ...
        self.btn_gender = Button(background_normal = image_gender_btn_blue, background_down = image_gender_btn_blue,size_hint = (None, None), size = (90, 45), pos_hint = {"x" : .75/800*x})
        self.btn_gender.on_press = self.gender
        layout.add_widget(self.btn_gender)
        
        btn_layer = Button(background_normal = "images/muscle.png", background_down = "images/muscle.png", size_hint = (None, None), size = (80, 80), pos_hint = {"x" : .75/800*x})
        btn_layer.on_press = self.layer
        layout.add_widget(btn_layer)

        btn_rotate = Button(size_hint = (None, None), size = (70, 70), pos_hint = {"x" : .75/800*x}, background_normal = "images/Rotate.png", background_down = "images/Rotate.png")
...
#########################################################################################################################        
    def gender(self):
        ...
        if gender_muscles=="man" and side_muscles=="forward":
            ...
            self.btn_biceps.pos=(370/800*x, 428/600*y)   #biceps
            self.tailor_muscle.pos=(340/800*x, 265/600*y) #tailor
            self.rectus_femoris_muscle.pos=(355/800*x, 240/600*y) #rectus
            self.Quadriceps_thigh_muscle.pos = (340/800*x, 200/600*y)
            self.lumbar.pos=(285/800*x, 300/600*y)
            self.abdominis.pos = (330/800*x, 365/600*y)
            self.forearm.pos = (425/800*x, 370/600*y)
            self.delta.pos = (245/800*x, 465/600*y)
            self.pectoral.pos = (340/800*x, 445/600*y)
            self.toothed.pos = (285/800*x, 385/600*y)
            self.triceps.pos = (235/800*x, 430/600*y)
            self.platysmal.pos = (310/800*x, 495/600*y)
            ...
            self.btn_biceps.pos = (350/800*x, 415/600*y)   #biceps
            self.tailor_muscle.pos = (310/800*x,265/600*y)    #tailor
            self.rectus_femoris_muscle.pos = (320/800*x, 240/600*y) #rectus
            self.lumbar.pos = (248/800*x, 315/600*y)
            self.Quadriceps_thigh_muscle.pos = (305/800*x, 200/600*y)
            self.delta.pos = (227/800*x, 455/600*y)
            self.forearm.pos = (360/800*x, 350/600*y)
            self.pectoral.pos = (320/800*x, 440/600*y)
            self.toothed.pos = (255/800*x, 390/600*y)
            self.abdominis.pos = (295/800*x, 370/600*y)
            self.triceps.pos = (230/800*x, 400/600*y)
            self.platysmal.pos = (290/800*x, 485/600*y)
            gender_muscles = "man"
            ...
            self.btn_gender.background_normal = image_gender_btn_pink
            self.btn_gender.background_down = image_gender_btn_pink
            self.triceps.pos = (250/800*x, 405/600*y)
            self.Gluteal_muscles.pos = (340/800*x, 275/600*y)
            self.back_muscle.pos = (292/800*x, 375/600*y)
            self.trapezius.pos = (315/800*x, 420/600*y)
            gender_muscles="woman"
            ...
            self.btn_gender.background_down = image_gender_btn_blue
            self.triceps.pos = (230/800*x, 400/600*y)
            self.Gluteal_muscles.pos = (320/800*x, 270/600*y)
            self.back_muscle.pos = (265/800*x, 370/600*y)
            self.trapezius.pos = (280/800*x, 400/600*y)
            gender_muscles="man"
#################################################################################################################################################
    def rotate(self):
        global gender_muscles
        ...
        if gender_muscles=="man" and side_muscles=="forward":
            ...
            self.fl_layout.add_widget(self.trapezius)
            self.Gluteal_muscles.pos = (340/800*x, 275/600*y)
            self.triceps.pos=(250/800*x, 400/600*y)
            self.back_muscle.pos = (292/800*x, 375/600*y)
            self.trapezius.pos = (315/800*x, 420/600*y)
            side_muscles="back"
...
class Skin(Screen):
    def __init__(self, **kwargs):
        ...
        btn_layer = Button(background_normal = "images/skin.png", background_down = "images/skin.png", size_hint = (None, None), size = (80, 80), pos_hint = {"x" : .75/800*x})
        btn_layer.on_press = self.layer
        layout.add_widget(btn_layer)
...
class Skeleton(Screen):
    def __init__(self, **kwargs):
        ...
        btn_layer = Button(background_normal = "images/Bone.png", background_down = "images/Bone.png", size_hint = (None, None), size = (80, 80), pos_hint = {"x" : .75/800*x})
        btn_layer.on_press = self.layer
        layout.add_widget(btn_layer)
...
class Print_info(Screen):
    def __init__(self, **kwargs):
        ...
        back_gr=Button(text = "", background_color = (0, 0, 0, 1), size_hint = (None, None), size = (600, 500), pos = (50/800*x, 50/600*y))
        back_gr.opacity = 0.6
        back_gr_white=Button(text = "", background_color = (1, 1, 1, 1), size_hint = (None, None), size = (520, 150), pos = (100/800*x, 380/600*y))
        back_gr_white.opacity = 0.4
        back_gr_white2=Button(text = "", background_color = (1, 1, 1, 1), size_hint = (None, None), size = (520, 105), pos = (100/800*x, 278/600*y))
        back_gr_white2.opacity = 0.3
        back_gr_white3=Button(text = "", background_color = (1, 1, 1, 1), size_hint = (None, None), size = (520, 200), pos = (100/800*x, 80/600*y))
        back_gr_white3.opacity = 0.2
        

        self.name_muscle = Label(text = key, pos=(-40/800*x,210/600*y),font_size='25sp')
        function_text = Label(text = "Функція", pos=(-50/800*x,180/600*y),font_size='20sp')
        self.function = Label(text = Dict_of_muscles[key]['Функція'], pos=(-40/800*x,125/600*y),font_size='18sp')
        injury_text = Label(text = "Травми/Хвороби", pos=(-50/800*x,60/600*y),font_size='20sp')
        self.injury = Label(text = Dict_of_muscles[key]['Травми/Хвороби'], pos=(-50/800*x,10/600*y),font_size='18sp')
        exercices_text = Label(text = "Корисні вправи", pos=(-50/800*x, -50/600*y),font_size='20sp')
        self.exercices = Label(text = Dict_of_muscles[key]['Корисні вправи'], pos=(-50/800*x, -100/600*y),font_size='18sp')

        Clock.schedule_interval(self.Update, 0.1)

        btn_close_bg = Button(text = "Нажми, чтобы закрыть", size_hint = (None, None), size = (190, 50), pos=(400/800*x, 0/600*y), background_color = yellow)
